...
<div class="my-12 border-y-2 border-black py-8">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
        <div>
            <div class="text-4xl font-black tsa-red">Deux licences</div>
            <div class="text-xs font-bold uppercase tracking-widest mt-2">Pour opérateurs internationaux et locaux</div>
        </div>
        <div>
            <div class="text-4xl font-black">100%</div>
            <div class="text-xs font-bold uppercase tracking-widest mt-2">Couverture du territoire national</div>
        </div>
        <div>
            <div class="text-4xl font-black">Objets connectés</div>
            <div class="text-xs font-bold uppercase tracking-widest mt-2">Pour l'agriculture et l'industrie</div>
        </div>
    </div>
</div>

## Déclaration exclusive du ministre Sid Ali Zerrouki

Dans une déclaration exclusive à **DIGITAL.DZ**, M. **Sid Ali Zerrouki**, Ministre de la Poste et des Télécommunications, a affirmé :

> *« Cette étape représente une phase importante dans le renforcement de l'infrastructure numérique de l'Algérie, en complément des infrastructures existantes. Nous visons à apporter des services Internet à haut débit à l'ensemble du territoire national, en particulier dans les zones difficiles d'accès. Cette initiative contribuera à soutenir la transformation numérique et à développer des solutions IoT dédiées aux grands projets structurants dans l'agriculture, l'industrie minière et les transports. »*
